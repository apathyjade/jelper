"use strict";(globalThis.webpackChunk_jelper_website=globalThis.webpackChunk_jelper_website||[]).push([[3587],{47347(e,t,n){n.d(t,{fv:()=>c,PE:()=>m,fI:()=>s});var i=n(68744);const a=e=>"string"==typeof e?e:"number"==typeof e?`${e}px`:"initial",o=i.AH`
  display: flex;
...
`,r=i.AH`
  flex: ${e=>{var t,n;return e.$fixed?"0 0 auto":`${null!==(t=e.$scale)&&void 0!==t?t:1} ${null!==(n=e.$scale)&&void 0!==n?n:1} auto`}};
  width: ${e=>a(e.$width)};
...
`,l=i.AH`
  flex: ${e=>{var t,n;return e.$fixed?"0 0 auto":`${null!==(t=e.$scale)&&void 0!==t?t:1} ${null!==(n=e.$scale)&&void 0!==n?n:1} auto`}};
  height: ${e=>a(e.$height)};
  min-height: ${e=>a(e.$minHeight)};
  max-height: ${e=>a(e.$maxHeight)};
  overflow: auto;
`,s=i.Ay.div`
  ${o}
`,c=i.Ay.div`
